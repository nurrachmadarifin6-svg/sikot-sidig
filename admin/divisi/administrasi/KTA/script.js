  ...
  try {
    ...
    files.forEach((file) => {
      ...
      card.innerHTML = `
        ...
        <button class="delete-btn" onclick="deleteKta('${file.id}')">Hapus</button>
      `;
...
//  UPLOAD FILE
// ========================
async function uploadKta() {
  const fileInput = document.getElementById("ktaInput");
...
//  DELETE FILE
// ========================
async function deleteKta(fileId) {
